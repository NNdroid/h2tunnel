...
func GenerateSelfSigned(domain string) (tls.Certificate, error) {
	...
	// Loopback is always usable: when a client connects to 127.0.0.1/[::1] it
	// verifies against the IP SAN. Without an IP SAN it would fail verification
	// outright, wedging a new user's very first hello-tunnel.
