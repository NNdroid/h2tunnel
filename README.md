...
```bash
bash -c "$(curl -L https://raw.githubusercontent.com/NNdroid/h2tunnel/refs/heads/main/scripts/install.sh)" @ install
```

### Option 2: Custom Parameters
Manually specify your secret Token and proxy Path:
```bash
bash -c "$(curl -L https://raw.githubusercontent.com/NNdroid/h2tunnel/refs/heads/main/scripts/install.sh)" @ install --token your_secret_token --path /your/secure/path
```
